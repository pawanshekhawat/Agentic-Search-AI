...
export function createServerClient() {
  ...
  if (!supabaseUrl || !supabasePublishableKey) {
    throw new Error(
      "Missing Supabase env vars. Expected one of: BUN_PUBLIC_SUPABASE_URL/VITE_SUPABASE_URL and BUN_PUBLIC_SUPABASE_PUBLISHABLE_KEY/VITE_SUPABASE_PUBLISHABLE_KEY."
    );
  }
